...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "flixcli",
		Short: "Command line interface for interacting with FLIX blockchain daemon (server)",
	}

	// Add --chain-id to persistent flags and mark it required
	rootCmd.PersistentFlags().String(client.FlagChainID, "", "Chain ID of FLIX node")
	...
	executor := cli.PrepareMainCmd(rootCmd, "FLIX", app.DefaultCLIHome)
